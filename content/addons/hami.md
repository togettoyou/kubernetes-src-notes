...
假设集群有 2 个节点各 4 块 GPU，节点1 已用 3 块，节点2 已用 2 块：
...
假设节点内 GPU1 已用 core 10%、mem 2000 MiB，GPU2 已用 core 70%、mem 6000 MiB，总显存 8000 MiB，本次申请 core 20%、mem 1000 MiB：

```
GPU1 得分 = ((20+10)/100 + (1000+2000)/8000) × 10 = 6.75
GPU2 得分 = ((20+70)/100 + (1000+6000)/8000) × 10 = 17.75
```
